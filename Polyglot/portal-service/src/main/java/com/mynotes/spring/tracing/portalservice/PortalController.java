...
public class PortalController {
    ...
    public String address(@PathVariable(name = "customerId", required = true) long customerId){
        ...
        String addressResponse=restTemplate.getForObject("http://address-service/api/address/customer",String.class);
        return "Customer Details : " + customerResponse+ "<br>" + "Customer Address : " +addressResponse;
    }
}
